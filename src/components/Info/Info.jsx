   ...
   <main role="main" className='info-wrapper'>
      ...
      <div className='social-media'>
         ...
         {`media-item ${userInfo.twitter_username === null ? 'opacity-media' : ''}`}>
            ...
            <a
            className={`twitter-link ${userInfo.twitter_username !== null ? 'underline-media' : 'no-pointer-events'}`}
         ...
         <div className=
            ...
            <a
               className={`website-link ${userInfo.blog !== "" ? 'underline-media' : 'no-pointer-events'}`}
               href={
                  userInfo.blog &&
         ...
         {`media-item ${userInfo.company === null ? 'opacity-media' : ''}`}>
            ...
            <a 
            className={`company-link ${userInfo.company !== null ? 'underline-media' : 'no-pointer-events'}`}
            href={
               userInfo.company
