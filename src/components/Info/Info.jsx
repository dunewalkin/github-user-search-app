  ...
  return (
   <div className='info-wrapper'>
      ...
      <div className='social-media'>
         ...
         <div className=
         {`media-item ${userInfo.location === null ? 'opacity-media' : ''}`}>
         ...
         <div className=
         {`media-item ${userInfo.twitter_username === null ? 'opacity-media' : ''}`}>
            ...
            <a 
            className={`twitter-link ${userInfo.twitter_username  !== null ? 'underline-media' : ''}`}
         ...
         <div className=
            {`media-item ${userInfo.blog === "" ? 'opacity-media' : ''}`}>
            <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg"><g >
            ...
            <a
               className={`website-link ${userInfo.blog !== "" ? 'underline-media' : ''}`}
               href={
                  userInfo.blog &&
                  (userInfo.blog.startsWith('https://') || userInfo.blog.startsWith('http://'))
                  ? userInfo.blog
                  : `https://${userInfo.blog}` || '#'
               }
               target="_blank"  
         ...
         <div className=
         {`media-item ${userInfo.company === null ? 'opacity-media' : ''}`}>
            <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg"><g >
            ...
            <a 
            className={`company-link ${userInfo.company !== null ? 'underline-media' : ''}`}
            href={
               userInfo.company
               ? `https://github.com/${userInfo.company.slice(1)}` || '#'
               : '#'
               // userInfo.company !== null ? `https://github.com/${userInfo.company.slice(1)}` : '#'
            }
            target="_blank"  
            rel="noopener noreferrer" 
            >
